...
subroutine zm_convr_run(     ncol    ,pver    , &
                    ...
                    ql      ,rliq    ,landfrac,                   &
! +++ Yi-Chi
                    rice    ,omega   ,lengath ,scheme_name, errmsg  ,errflg)
! --- Yi-Chi
...
!
   ...
   ! +++ Yi-Chi
   real(kind_phys), intent(in) :: omega(:,:)      ! grid slice of omega at mid-layer.           (ncol,pver)
   ! --- Yi-Chi
...
!
   ...
   ! --- Parameter ---
   !real(kind_phys) c1 ,c2, c3
   real(kind_phys), parameter :: c1 = 6.112_kind_phys
